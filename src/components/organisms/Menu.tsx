  ...
  return (
    <Cmp
      className={[
        ...
        "text-[var(--mono-label)] group-hover:text-[var(--mono-bg)]",
        className || "",
      ]
        .filter(Boolean)
        .join(" ")}
    ...
    items: [
      {
        ...
        visible: ["sysadmin", "admin,", "teknisi".replace(",", "")] as Role[],
      },
      {
        icon: "history",
        label: "Riwayat Tiket",
    ...
    () =>
      MENU_RAW.map((g) => ({
        ...
        items: g.items.filter((it) =>
          it.visible.includes((role as Role) ?? "admin")
        ),
              ...
              {g.items.map((item) => (
                <Link
                  ...
                  className={[
                    ...
                    "py-2 px-3 transition duration-200",
                    "text-[var(--mono-fg)] hover:text-[var(--mono-bg)]",
                    "hover:bg-[var(--mono-fg)]",
                  ].join(" ")}
                >
                  <Icon name={item.icon} />

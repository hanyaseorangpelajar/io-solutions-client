...
export default function InventoryItemForm({
  ...
  // simpan numerik sebagai string agar aman untuk InputLabelField
  ...
  const onSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO kirim ke backend — parse string → number bila perlu sebelum kirim
    onClose();
  };
    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-3">
      ...
      <div className="mt-2 flex items-center justify-end gap-2">
        ...
        {type !== "read" && (
          ...
          >
            {type === "create" ? "Simpan" : "Simpan Perubahan"}
          </button>
        )}
      </div>
    </form>
